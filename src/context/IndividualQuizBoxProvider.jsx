...
export default function IndividualQuizBoxProvider({ children }) {
  ...
  function ScoreCalculator() {
    ...
    const negativeScore = WrongAnswers.length * nagetiveMarking;
  ...
  function testSubmitHandle() {
    ...
    setTimeout(() => {
      ...
      localStorage.setItem(
        "CorrectAns",
        Result.CorrectAnswers.map((e) => JSON.stringify(e)).join(" "),
      );
      localStorage.setItem(
        "WrongAns",
        Result.WrongAnswers.map((e) => JSON.stringify(e)).join(" "),
      );
      ...
      localStorage.setItem("marked", state.marked.join(" "));
