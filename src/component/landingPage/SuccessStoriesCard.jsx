    ...
    <>
      ...
      <div className="p-10 bg-on-secondary shadow-xl rounded-xl flex flex-col gap-7 relative">
        ...
        <p className="font-body-lg text-lg text-on-surface-variant italic leading-relaxed">
          "MUETPrep helped me score 90+! The mock tests were incredibly accurate
          to the actual exam difficulty. The analytics helped me focus on
          exactly what I needed to improve."
        </p>
      </div>
    </>
  );
