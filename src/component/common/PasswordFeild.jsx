...
import InputInlineError from "./InputInlineError";

export default function PasswordFeild({ register, errors }) {
      ...
      <div className="relative">
        ...
        >
          <span className="material-symbols-outlined visibleIcon">
            {isPasswordVisible.password ? "visibility" : "visibility_off"}
          </span>
        </button>
      </div>
    </>
