          ...
          <div className="w-full px-6 py-4 space-y-4 md:space-y-6 ">
            ...
            <form className="space-y-4 md:space-y-2 " action="">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    className="w-full pl-10 pr-4 py-3 focus:-shadow-blue-primary focus:  rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-all outline-1 font-body-md text-body-md text-on-surface  bg-surface-container-low"
                    id="name"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-1 @max-3xl:grid-cols-2  gap-3">
                <div className="">
                  <label
                    htmlFor="password"
                    className="block mb-2 text-sm font-medium text-gray-900 "
            ...
            <div>
                ...
                <div className="relative">
                  ...
                  <select name="dropDown" id="DropDown"  value={formData.dropDown} onChange={handleChange} className="w-full pl-10 pr-12 py-3 bg-surface-container-low border border-outline-variant rounded-lg focus:ring-2 focus:ring-primary focus:border-primary transition-all outline-1 font-body-md text-body-md text-on-surface font-medium cursor-pointer">
                        <option value="" selected className="font-bold">Select Your Goal University</option>
                        <option value="NUST" selected className="font-medium ">NUST</option>
                        <option value="Mehran" selected className="font-medium">Mehran</option>
                        <option value="Fast" selected className="font-medium">Fast</option>
                        <option value="LUMS" selected className="font-medium">LUMS</option>
                  </select>
                  <button
                    className="absolute right-3 top-1/2 -translate-y-1/2 text-outline hover:text-primary transition-colors"
                    type="button"
